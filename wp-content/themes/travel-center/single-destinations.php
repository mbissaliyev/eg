...
<section class="d-flex p-5 ">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-12 text-center pb-4 pl-0 pr-0">
        ...
        <div class="row">
            <div class="col-4 col-md-4 push-md-4">
                <p>Погода:</p>
            </div>
            <div class="col-8 col-md-2 push-md-1">
            ...
            <div class="col-md-12">
                ...
                <div class="card wow fadeInLeft">
                    ...
                    <div class="card-block">
                        ...
                        <?php
                        $hotel_id = get_field('promo_hotel_dest_1')[0]->ID;
                        $hotel_offers = get_field('hotel_features', $hotel_id);

                        foreach ($hotel_offers as $ho): ?>
                        <span class="badge badge-primary"><?php echo get_term($ho)->name?></span>
                        <?php endforeach;?>
                        <hr>

                        <a href="#" class="btn btn-lime">Забронировать <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                    <!--/.Card content-->
                ...
                <div class="col-xs-12 col-md-4 mt-1">
                    ...
                    <div class="card wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="card-block">
                            ...
                            <?php  $post_type = get_post_type($f);
                            if ($post_type == 'restaurant'):
                                $rest_term_id = get_field('restaurant_features', $f);

                                ?>

                            <p class="card-text">
                                <?php foreach ($rest_term_id as $r):?>
                                    <a target="_blank" href="https://www.viamichelin.com/web/Restaurant/SAN_CASSIANO-39030-St_Hubertus-124487-41102">
                                    <img src="http://dev.eg.travelcenter.kz/wp-content/uploads/2017/04/Michelin-restaurant-Florence.jpg" width="50" height="50">
                                    </a>
                                <span class="badge badge-primary"><?php echo get_term($r)->name?></span>
                                <?php endforeach;?>
                            </p>
                            <?php endif?>
                            <!--Text-->
